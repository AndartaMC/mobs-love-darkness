...
| `LightFixationChance` | 0.05 | Chance per `canStart()` check that an eligible mob fixates. Range: 0.0–1.0 |
...
- Block protection mods (GriefPrevention, FTB Chunks, etc.) — protected blocks are detected and blacklisted
