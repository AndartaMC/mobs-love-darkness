...
public class LightSourceDestroyerConfig {
    public String _comment_LightSourceSearchRadius = "How far away from mob to search for light sources. Min: 1 Max: 128 Default: 16";
    public int LightSourceSearchRadius = 16;
    public String _comment_LightSourceBreakTimeTicks = "How many ticks it takes to break a light source. Min: 1 Max: 1200 Default: 20";
    public int LightSourceBreakTimeTicks = 20;
    public String _comment_LightFixationSpeedMultiplier = "How movement speed should change while mob is moving toward a light source. Min: 0.1 Max: 10.0 Default: 0.85";
    public float LightFixationSpeedMultiplier = 0.85F;
    public String _comment_LightFixationChance = "How often a mob with the light fixation goal should fixate on light sources. Min: 0.0 Max: 1.0 Default: 0.05";
    public float LightFixationChance = 0.05F;
    public String _comment_LightFixationCooldownTicks = "How long to wait after destroying a light source before targeting a new one. Min: 0 Max: 72000 Default: 200";
    public int LightFixationCooldownTicks = 200;
    public String _comment_LightFixationGoalPriority = "Goal priority for the light fixation behavior. Lower numbers take priority over higher numbers. Vanilla zombie attack goal is priority 2. Recommended values: 1 (high priority, overrides most behaviors) 3 (low priority, most other behaviors take precedence). Min: 1 Max: 10 Default: 3";
    public int LightFixationGoalPriority = 3;
    public String _comment_EnableParticles = "Should particle effects be used while the mob is targeting a light source? Allowed values: true/false Default: true";
    public boolean EnableParticles = true;
    public String _comment_EnableSounds = "Should sounds be played when the mob starts targeting and destroys a light source? Allowed values: true/false Default: true";
    public boolean EnableSounds = true;
    public String _comment_EnableLightFixationGlowEffect = "Should fixated mobs glow? Makes them easier to identify. Allowed values: true/false Default: true";
    ...
    public String _comment_TargetableLightSources = "Which blocks are valid light sources to target? Provide an array of blocks including mod prefix. Default: [ \"minecraft:torch\", \"minecraft:wall_torch\", \"minecraft:lantern\", \"minecraft:soul_torch\", \"minecraft:soul_lantern\", \"minecraft:campfire\", \"minecraft:soul_campfire\" ] ";
    ...
    public String _comment_LightFixationEligibilityChancePerMobType =
            "Chance for each mob type to receive the light fixation goal when spawned. " +
                    "Each value needs the mob type with mod prefix followed by the probability Min: 0.0 Max: 1.0. Mob types not listed will not receive the goal. " +
                    "Default: { \"minecraft:zombie\": 0.05, \"minecraft:husk\": 0.05, \"minecraft:zombie_villager\": 0.05, \"minecraft:zombified_piglin\": 0.05, \"minecraft:phantom\": 0.75 }";
    ...
    public transient Set<String> TargetableLightSourcesSet;
    ...
    public void init() {
        validate();
        TargetableLightSourcesSet = new HashSet<>(TargetableLightSources);
    }
